...
private func process(
  ...
  guard let output = regex.matchWhole(line),
...
extension RegexTests {
  ...
  func testBankStatement() {
    ...
    for line in statement.split(separator: "\n") {
      ...
      print("NSRegularExpression")
      print(processWithNSRegularExpression(line)!)

      _ = processWithRuntimeDynamicRegex(line)

      print("Static run-time regex")
      print(processWithRuntimeStaticRegex(line)!)

      print("DSL")
      print(processWithDSL(line)!)
