...
extension RegexTests {
  ...
  func testReverseMatchQuantification() {
    // MARK: Quantification
  ...
  func testReverseQuantificationScalarSemantics() {
  ...
  func testReverseMatchCharacterClasses() {
  ...
  func testReverseCharacterProperties() {
  ...
  func testReverseMatchAnchors() throws {
    // Must have new stdlib for character class ranges and word boundaries.
    guard ensureNewStdlib() else { return }
  ...
  func testReverseLevel2WordBoundaries() {
    // Must have new stdlib for character class ranges and word boundaries.
    guard ensureNewStdlib() else { return }
  ...
  func testReverseMatchCaptureBehavior() {
    flatCaptureTest(
      #"a(b)c|abe"#,
      ("abc", ["b"]),
      ("abe", [nil]),
  ...
  func testReverseMatchReferences() {
    firstMatchTest(
      #"(.)\1"#,
      input: "112", match: "11")
    firstMatchTest(
  ...
  func testReverseSingleLineMode() {
  ...
  func testReverseCaseSensitivity() {
    // Must have new stdlib for character class ranges and word boundaries.
    guard ensureNewStdlib() else { return }
  ...
  func testReverseNonSemanticWhitespace() {
  ...
  func testReverseAnchorMatching() throws {
    let string = """
      01: Alabama
      02: Alaska
      03: Arizona
  ...
  func testReverseSubstringAnchors() throws {
  ...
  func testReverseMatchingOptionsScope() {
  ...
  func testReverseOptionMethods() throws {
  ...
  func testIndividualReverseScalars() {
  ...
  func testReverseCanonicalEquivalence() throws {
  ...
  func testReverseCanonicalEquivalenceCharacterClass() throws {
  ...
  func testReverseCanonicalEquivalenceCustomCharacterClass() throws {
  ...
  func testReverseAnyChar() throws {
  ...
  func testReverseScalarOptimization() throws {
  ...
  func testReverseConcurrentAccess() async throws {
    for _ in 0..<1000 {
  ...
  func testReverseQuantificationForwardProgress() {
  ...
  func testReverseQuantifyOptimization() throws {
  ...
  func testReverseFuzzerArtifacts() throws {
    expectCompletion(regex: #"(b?)\1*"#, in: "a")
  }

  func testReverseIssue640() throws {
  ...
  func testReverseIssue713() throws {
  ...
  func testReverseNSRECompatibility() throws {
